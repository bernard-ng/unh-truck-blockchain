class TrucksController < ApplicationController
  ...
  def update
    if @truck.update(truck_params)
      redirect_to @truck, notice: "Truck was successfully updated.", status: :see_other
    else
  ...
  def destroy
    @truck.destroy!
    redirect_to trucks_url, notice: "Truck was successfully destroyed.", status: :see_other
  end
